...
class PostsController extends Controller
{
    ...
    {   $dishes=Dish::all();
        ...
        return view('dishes.china')
        ->with('dishes',Dish::orderBy('updated_at','DESC')->get());
    ...
    {
        return view('dishes.chinaCreate');
    }
    ...
    return view('dishes.chinaEdit',$data);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function updateChina(Request $request)
    {
    ...
    public function Chinadelete($id){
        $chinadelete=DB::table('dishes')
        ->where('id',$id)
        ->delete();
        return redirect('/china')
    ...
    //     return view('dishes.georgia')
    //     ->with('dishes',Dish::orderBy('updated_at','DESC')->get());
        
        
    // }

    // public function createGeorgia()
    // {
    //     return view('dishes.georgiaCreate');
    // }



    // public function storeGeorgia(Request $request)
    // {
